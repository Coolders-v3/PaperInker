...
Route::view('/showIllustrator', 'livewire.show-illustrator')->middleware('auth')->name('showIllustrator');
Route::view('/showWriter', 'livewire.show-illustrator')->middleware('auth')->name('showWriter');